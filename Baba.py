...
╚╝─╚╩╝╚╩══╩╝╚╩══╩══╝
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Faisu Baba             |"
    print GL+"  |       Faisu Baba Real Parogramer       |"
    print WW+"  |            FACEBOOK: Fasi Baba            |"
    print Y+"  |             INSTAGRAM: Faiissu              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        FT MALIK BABA [ F.M.B ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
...
print wd+"         https://www.github.com/FAISU "
         ...
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
              `-/+///..````..://+/-`
                ...
                \033[90;1mThe Real Programer Fasisu Baba\033[91;1m
              Powered by:\033[97mDark Hunter
      """
